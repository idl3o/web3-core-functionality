...
class VideoLoader {
  constructor(options = {}) {
    this.options = {
      ...
      fallbackVideo: 'https://test-videos.co.uk/vids/bigbuckbunny/mp4/h264/720/Big_Buck_Bunny_720_10s_1MB.mp4',
      loadingDelay: 1000,
      ...options
    };
  }
  ...
  loadVideo(cid, callback) {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        const videoUrl = cid 
          ? `${this.options.ipfsGateway}${cid}` 
          : this.options.fallbackVideo;
